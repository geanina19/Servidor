            ...
            <fieldset>
                <form method="POST">
                    ...
                    <select name="deportes[]" multiple="multiple" size="3">
                        <option value="Futbol"    <?= in_array("Futbol", $deportes) ? "selected" : ""; ?>>Futbol</option>
                        <option value="Tenis"     <?= in_array("Tenis", $deportes) ? "selected" : ""; ?>>Tenis</option>
                        <option value="Ciclismo"  <?= in_array("Ciclismo", $deportes) ? "selected" : ""; ?>>Ciclismo</option>
                        <option value="Otro"      <?= in_array("Otro", $deportes) ? "selected" : ""; ?>>Otro</option>
                    </select>
                    <br>
